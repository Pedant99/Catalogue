...
String query = "select * from app where app_id='"+no+"'";
Statement st = conn.createStatement();
ResultSet rs = st.executeQuery(query);
while(rs.next()){
%>
<div><h6>Application Name</h6></div>
<div><input type="text" name="app_name" value="<%=rs.getString("app_name")%>"></div>

<div><h6>User</h6></div>
<div><input type="text" name="link1" value="<%=rs.getString("link1")%>"></div>

<div><h6>Administrator</h6></div>
<div><input type="text" name="link2" value="<%=rs.getString("link2")%>"></div>

<div><h6>New User</h6></div>
<div><input type="text" name="link3" value="<%=rs.getString("link3")%>"></div>

<div><h6>Description</h6></div>
<div><input type="text" name="description" value="<%=rs.getString("description")%>"></div>
